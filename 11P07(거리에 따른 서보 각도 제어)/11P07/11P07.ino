...
#define _DUTY_NEU 1477 // servo neutral position (90 degree) 1471 = 89->90 , 1482 = 90->91
#define _DUTY_MAX 2399 // servo full counterclockwise position (180 degree)

// global variables
float timeout; // unit: us
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, alpha, calc, duty_min, duty_max; // unit: mm
...
// get a distance reading from the USS
  ...
  if(dist_ema < 180){
    ...
    calc = (dist_ema-180.0)*(duty_max-duty_min)/180.0 + duty_min;
  }
...
// adjust servo position according to the USS read value
  ...
  if(dist_ema < 180.0) {
    ...
    myservo.writeMicroseconds(calc);
  }
